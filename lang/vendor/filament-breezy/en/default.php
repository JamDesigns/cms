...
return [
    ...
    'registration' => [
        ...
        'notification_unique' => 'An account already exists associated with this email. Please access.',
    ],
    'reset_password' => [
        'title' => 'Password recovery',
        'heading' => 'Creating a new password',
        'submit' => [
            'label' => 'Send',
        ],
        'notification_error' => 'Error: Try again later.',
        'notification_error_link_text' => 'Try Again',
        'notification_success' => 'An email has been sent, open the message to follow the instructions.',
    ],
    'verification' => [
        'title' => 'Email verification',
        'heading' => 'You must verify your email account',
        'submit' => [
            'label' => 'Logout',
        ],
        'notification_success' => 'An email has been sent, open the message to follow the instructions.',
        'notification_resend' => 'The email with the instructions has been forwarded.',
        'before_proceeding' => 'Before continuing, check the email that has been sent to you and click on the activation link.',
        'not_receive' => 'If you have not received the email message,',
