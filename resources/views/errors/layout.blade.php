...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <meta name="author" content="Jose Mosquera">
    ...
    <body class="bg-gray-100 font-family-karla antialiased">
        @php
        ...
        <div class="container mx-auto py-8">
            ...
            <main>
                <div class="w-full h-full flex flex-col items-center justify-center">
                    <svg class="w-1/2 md:w-1/3 lg:w-1/4 text-blue-600" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <path d="M341,359.5s130-36,138,80-107,149-17,172" transform="translate(-31.39089 -100.5)"
                        ...
                        <rect x="578.43291" y="212.68859" width="513.25314" height="357.51989" rx="18.04568"
                            fill="#2f2e41">
                        </rect>
                    ...
                    <div class="flex flex-col items-center justify-center">
                        <p class="text-5xl md:text-6xl lg:text-7xl font-bold tracking-wider text-gray-600 mt-8">
                            @yield('code')</p>
                        <p class="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-600 mt-2">@yield('title')</p>
                        <p class="md:text-lg xl:text-xl text-gray-500 mt-4">@yield('message')</p>
                    </div>

                    <div class="flex flex-col items-center justify-center mt-4">
                        <a class="inline-flex items-center px-4 py-2 bg-indigo-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 focus:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150"
                            href="{{ route($route === $adminRoute ? 'dashboard' : 'home') }}">
                            {{ __('Back') }}
                        </a>
                    </div>
                </div>
